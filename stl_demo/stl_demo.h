 ...
 * @Last Modified time: 2021-01-19 17:54:31
 */
#include "typeinfo"
#include <iostream>
#include <vector>
...
template <class InputIterator> void printIterator(const string &name, InputIterator first, InputIterator last) {
    cout << name << ":";
